...
<img src={logo1} alt="Logo" className="w-24 h-24 object-contain mx-auto mb-5 rounded-full border-4 border-white/30 shadow-lg"/>
...
বদর উদ্দিন বেপারী কল্যাণ সংস্থা একটি পারিবারিক সামাজিক উদ্যোগ।
আমরা আশেপাশের অসহায় ও সুবিধাবঞ্চিত মানুষের পাশে দাঁড়ানোর জন্য কাজ করি।
</p>

<p className="text-gray-600 leading-relaxed text-base mt-3">
আমাদের সদস্যরা প্রতি মাসে স্বেচ্ছায় কিছু অর্থ অনুদান দেন।
এই অর্থ দিয়ে আমরা দরিদ্র মানুষের চিকিৎসা, শিক্ষা এবং জরুরি সহায়তায় সাহায্য করার চেষ্টা করি।
</p>
</section>
...
{MEMBERS.map((m)=>(
<div key={m.id} className="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 hover:-translate-y-1">
<div className="aspect-square overflow-hidden bg-emerald-50">
<img src={m.photo||memberLogo} alt={m.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"/>
</div>
...
{[
{icon:"🤝",title:"আমাদের লক্ষ্য",text:"অসহায় মানুষের পাশে দাঁড়ানো এবং তাদের সাহায্য করা।"},
{icon:"💚",title:"আমাদের মূল্যবোধ",text:"সততা, স্বচ্ছতা এবং মানবতার প্রতি দায়বদ্ধতা।"},
{icon:"🌟",title:"আমাদের স্বপ্ন",text:"একটি সুখী ও সহায়ক সমাজ গড়ে তোলা।"}
].map((item)=>(

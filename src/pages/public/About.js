...
// Current Bengali month name e.g. "এপ্রিল"
      ...
      {members.map((m, index) => (
        ...
        >
          <div className="relative aspect-square overflow-hidden bg-emerald-50">
            ...
            {tab === "top" && index < 3 && (
              <div
                className={`absolute top-2 left-2 w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold shadow-md text-white
          ...
          <div className="p-3 text-center">
            ...
            {tab === "active" && (
              <span className="inline-flex items-center gap-1 mt-1 text-xs text-emerald-600 font-medium">
                ...
                {currentMonthBn} মাসের অনুদানকারী
              </span>
            )}
            {tab === "top" && (
...
function MembersSection() {
  ...
  const tabs = [
    { id: "active", label: `${currentMonthBn} মাসের অনুদানকারী`, icon: "🟢" },

...
const router = createBrowserRouter([
  ...
  { path: "/portal/help-requests", element: <PortalWrapper adminOnly={true}><HelpRequests /></PortalWrapper> },
  { path: "/portal/messages",      element: <PortalWrapper adminOnly={true}><Messages /></PortalWrapper> },
  { path: "/portal/news-manage",   element: <PortalWrapper adminOnly={true}><NewsManage /></PortalWrapper> },
